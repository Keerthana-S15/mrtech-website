...
// Creates a new company's admin account. Only MRtech's super admin
// can call this (protected by requireAdmin + requireSuperAdmin middleware
// on the route). This is how you onboard a new company.
export const createCompanyAdmin = async (req, res) => {
  try {
...
// ✅ NEW: Lists all company admin accounts (excluding passwords) — only
// MRtech's super admin can see this, used to populate the "Companies" tab
